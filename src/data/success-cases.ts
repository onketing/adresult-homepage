...
export const CASE_ARTICLES: CaseArticle[] = [
	{
		slug: "167560631",
		title: "[병원 평판관리] 악성리뷰 확인만으로는 부족해요",
		excerpt:
			"애드리절트는 병원의 온라인 평판 관리를 위해 각자 담담하고 있는 고객사의 리뷰 및 채널을 매일매일 모니터링을 하고 있는데요. 최근에 한 병원에서 악성 댓글이 계속 달려 힘들어하시던 상황이 있었어요. 환자분이 네이버 리뷰뿐만 아니라 카카오맵에까지 악성 리뷰를 달아두셨더라고요. ㅠㅠ 어떻게",
		summary:
			"애드리절트는 고객사 병원의 리뷰와 채널을 매일 모니터링합니다. 악성 리뷰가 달린 병원에는 카카오맵 대응 팁을 정리해 전달하는 등, 단순히 악플만 확인하는 1차원 모니터링을 넘어 실질적인 고민을 함께 해결합니다.",
		faq: [
			{
				q: "병원 평판 관리는 어떻게 하나요?",
				a: "고객사의 리뷰와 채널을 매일 모니터링하고, 악성 리뷰가 생기면 매체별(네이버·카카오맵) 대응 방법을 정리해 전달합니다. 단순 악플 확인을 넘어 환자 입장의 개선 의견까지 제안합니다.",
			},
			{
				q: "악성 리뷰가 달리면 어떻게 대응하나요?",
				a: "병원에 피해가 최소화되도록 매체별 대응 팁을 정리해 바로 적용할 수 있게 전달합니다. 실제로 카카오맵 대응 방법을 정리해 드려 병원이 바로 적용한 사례가 있습니다.",
			},
			{
				q: "평판 관리도 광고 회사가 해주나요?",
				a: "네. 애드리절트는 광고만 관리하는 것이 아니라 매일 꼼꼼한 평판 관리, 상황에 맞춘 맞춤 전략, 오래 함께하는 지원으로 병원의 실질적인 고민을 함께 해결합니다.",
			},
		],
		cover: "/images/cases/167560631/1.png",
		coverW: 364,
		coverH: 1358,
		blocks: [
			{
				...
				runs: [
					{
						t: "애드리절트는 병원의 온라인 평판 관리를 위해 각자 담담하고 있는",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "고객사의 리뷰 및 채널을 매일매일 모니터링을 하고 있는데요.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "최근에 한 병원에서 악성 댓글이 계속 달려 힘들어하시던 상황이 있었어요.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "환자분이 네이버 리뷰뿐만 아니라 카카오맵에까지 악성 리뷰를 달아두셨더라고요. ㅠㅠ",
						fs: 18,
						k: 0,
					},
				],
			...
			{
				type: "img",
				src: "/images/cases/167560631/1.png",
				w: 364,
				h: 1358,
				alt: "[병원 평판관리] 악성리뷰 확인만으로는 부족해요",
				id: 4,
			},
			{
				type: "p",
				runs: [
					{
						t: "어떻게 해야 최대한 병원에 피해가 가지 않을까 고민하며 알아보다 카카오맵에 적용하면 좋을 것 같은 꿀팁을 발견했습니다!",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "애드리절트의 평판 관리는 단순하게 악플만 체크하는 그런 1차원적인 모니터링이 아닙니다!",
						b: true,
						c: "#ff0000",
						fs: 18,
						bg: "#cccccc",
			...
			},
			{
				...
				runs: [
					{
						t: "바로 알아보시기 쉽게 내용을 정리하여 팀장님께 전달해 드렸는데, 고맙다는 인사를 하시고 바로 적용하시더라고요 ^^",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "매체별로 다른 팁이나 아이디어가 있으면 또 공유해달라는 말씀까지 해주셨습니다. ㅎㅎ",
						fs: 18,
						k: 0,
					},
				],
			...
			{
				type: "img",
				src: "/images/cases/167560631/2.png",
				w: 370,
				h: 320,
				alt: "3a963c0a6f2ad.png",
				id: 9,
			},
			{
				type: "img",
				src: "/images/cases/167560631/3.png",
				w: 364,
				h: 1133,
				alt: "병원평판",
				id: 10,
			},
			{
				...
				runs: [
					{
						t: "환자의 입장에서 봤을 때 개선하면 더욱 좋을 거 같은 개인적인 의견을 전달해 드렸는데",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이런 순간마다 단순히 광고만을 관리하는 게 아닌 고객사의 실질적인 고민을",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "함께 해결해 나가는 파트너라는 걸 다시 한번 느끼게 됩니다. ㅎㅎ",
						k: 0,
					},
				],
				align: "center",
	...
	{
		slug: "167560320",
		title: "[병원마케팅추천] 필요한 부분은 미리 제안드리는 회사에서",
		excerpt:
			"이번에 소개해 드릴 병원은 블로그 광고를 3년 정도 진행하신 병원입니다. 꽤 오랫동안 광고를 진행하다 보니 비슷한 게시물 내용이 반복돼서 신선함이 부족한 상태였습니다. 마침, 올해 타이밍 좋게 해당 병원이 종합병원으로 승격하며 새로운 진료 과목 또한 추가된 시점이라 전체적으로 블로그 콘",
		summary:
			"블로그 광고를 3년간 진행해 콘텐츠가 반복되던 병원에, 애드리절트가 먼저 전면 리뉴얼을 제안한 사례입니다. 종합병원 승격·새 진료과목 추가 시점에 맞춰 콘텐츠와 디자인을 새로 단장했습니다.",
		faq: [
			{
				q: "오래된 장기 고객은 어떻게 관리하나요?",
				a: "장기 고객을 방치하지 않고, 콘텐츠가 반복되면 먼저 리뉴얼을 제안합니다. 이 병원은 종합병원 승격 시점에 맞춰 블로그 콘텐츠와 디자인을 전면 리뉴얼했습니다.",
			},
			{
				q: "애드리절트는 어떤 기준으로 제안하나요?",
				a: "'병원 입장에서' 도움이 될 만한 내용만 먼저 제안합니다. 리뉴얼처럼 번거로울 수 있는 작업도 병원 성장에 필요하다면 선제적으로 제안드립니다.",
			},
		],
		cover: "/images/cases/167560320/1.png",
		coverW: 364,
		coverH: 702,
		blocks: [
			{
				...
				runs: [
					{
						t: "이번에 소개해 드릴 병원은 블로그 광고를 3년 정도 진행하신 병원입니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "꽤 오랫동안 광고를 진행하다 보니 비슷한 게시물 내용이 반복돼서 신선함이 부족한 상태였습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					...
					{
						t: " 오래된 장기 고객(병원)을 절대로 그냥 방치하지 않습니다.",
						b: true,
						c: "#ff0000",
						fs: 20,
						bg: "#cccccc",
			...
			},
			{
				...
				runs: [
					{
						t: "마침, 올해 타이밍 좋게 해당 병원이 종합병원으로 승격하며 새로운 진료 과목 또한 추가된 시점이라",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "전체적으로 블로그 콘텐츠와 디자인을 한 번 싹 리뉴얼하자고 제안",
						b: true,
						bg: "#ffd966",
						k: 0,
					},
			...
			{
				type: "img",
				src: "/images/cases/167560320/1.png",
				w: 364,
				h: 702,
				alt: "f9fe157aced04.png",
				id: 5,
			},
			{
				type: "p",
				runs: [
					{
						t: "사실 블로그 리뉴얼 이라는게 많은 시간과 소통을 요구하는 작업이기에",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "마케터 뿐만 아니라 병원 원장님과 실장님, 팀장님 입장에서도 번거롭게 느낄 수도 있는데요.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					...
					{
						t: '"병원의 입장에서" 병원에 도움이 될 만한 내용만 제안',
						bg: "#ffd966",
						k: 1,
					},
					{
			...
			},
			{
				...
				runs: [
					{
						t: '다행히 담당자분께서도 "늘 제안해 주셔서 감사하다"며, 해당 제안을 긍정적으로 검토해 주셨습니다.',
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "병원 브랜딩과 마케팅, 결국 이 작은 차이 하나하나가 모여 큰 성과를 만들어 냅니다.",
						k: 0,
					},
				],
				align: "center",
	...
	{
		slug: "167545669",
		title: "[병원개원] 3개월 만에 예약 마감 달성한 비결",
		excerpt:
			"최근 들어 네트워크에 소속되어 있다 분리하여 병원을 개원하시는 원장님들이 많습니다. 네트워크를 탈퇴 후 개원을 하신 원장님들과 미팅을 하면, 대부분 운영 제한을 그 이유로 꼽는데요. 내가 원하는 방향에 맞춰 병원을 운영하고 싶다는 마음과 동시에 인지도를 포기하는 것이기에 과연 빨리 자리",
		summary:
			"네트워크를 탈퇴하고 독립 개원한 통증치료 병원이, 개원 1달 전부터 애드리절트와 준비해 개원 3개월 만에 예약이 꽉 차 더 이상 환자를 받지 못할 정도로 자리 잡았습니다.",
		faq: [
			{
				q: "개원 3개월 만에 예약 마감이 어떻게 가능했나요?",
				a: "개원 전부터 마케팅을 준비하고, 원장님이 '마케팅은 선투자'라며 과감히 투자해 9~10가지 상품이 시너지를 냈으며, 환자에 대한 진심이 더해져 개원 3개월 만에 예약이 꽉 찼습니다.",
			},
			{
				q: "개원 병원은 언제부터 준비해야 하나요?",
				a: "개원 초가 마케팅에서 가장 중요합니다. 이 병원은 개원 1달 전부터 함께 준비해 의원명·슬로건·진료 철학을 정리했고, 그 덕에 개원과 동시에 좋은 출발을 했습니다.",
			},
			{
				q: "네트워크에서 독립하면 인지도가 걱정되지 않나요?",
				a: "인지도를 새로 쌓아야 하지만, 개원 전부터 브랜딩 콘텐츠를 준비하고 과감히 투자하면 빠르게 자리 잡을 수 있습니다. 이 병원은 3개월 만에 예약 마감을 달성했습니다.",
			},
		],
		cover: "/images/cases/167545669/1.png",
		coverW: 589,
		coverH: 285,
		blocks: [
			{
				...
				runs: [
					{
						t: "최근 들어 네트워크에 소속되어 있다 분리하여 병원을 개원하시는 원장님들이 많습니다.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "네트워크를 탈퇴 후 개원을 하신 원장님들과 미팅을 하면, 대부분 운영 제한을 그 이유로 꼽는데요.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "내가 원하는 방향에 맞춰 병원을 운영하고 싶다는 마음과 동시에 인지도를 포기하는 것이기에",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "과연 빨리 자리를 잡을 수 있을까에 대한 고민을 많이 하십니다.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "해당 병원은 의사와 한의사 복수 면허를 가지고 계신 원장님께서 비수술적 통증 치료를 주로 진행하는 병원으로,",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "기존 네트워크에 속해 있다가 독립하여 병원을 개원하신 케이스입니다.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "아무래도 네트워크 소속이다 보니 자율성이 별로 없었고 병원마케팅 또한 월 블로그 5건 정도로 도움을 크게 받지도 못하는데",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "또 비용은 많이 들어 탈퇴를 결심하시게 되셨다고 합니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "( 6월 재개원 예정이었으며 애드리절트와 함께 개원 1달 전부터 소통하며 착실히 준비해 나갔습니다. )",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "병원을 개원한 지 3개월 차인 요즘, 원장님께서는 예약이 전부 차",
						c: "#ff0000",
						fs: 18,
						k: 0,
					},
			...
			},
			{
				...
				runs: [
					{
						t: "더 이상 환자를 받지 못할 정도로 운영이 잘 되고 있다는 피드백을 주셨습니다.",
						c: "#ff0000",
						fs: 18,
						k: 0,
					},
			...
			},
			{
				...
				runs: [
					{
						t: "저희도 개원 전부터 계속 함께 해온 병원이 빨리 성공적으로 자리를 잡게 되어 정말 기뻤는데요. ㅎㅎ",
						k: 0,
					},
				],
				align: "center",
			...
			{
				type: "img",
				src: "/images/cases/167545669/1.png",
				w: 589,
				h: 285,
				alt: "병원마케팅광고",
				id: 17,
			...
			{
				type: "img",
				src: "/images/cases/167545669/2.png",
				w: 589,
				h: 257,
				alt: "병의원마케팅",
				id: 18,
			...
			{
				type: "img",
				src: "/images/cases/167545669/3.png",
				w: 589,
				h: 257,
				alt: "대구병원마케팅",
				id: 19,
			...
			},
			{
				...
				runs: [
					{
						t: "해당 병원은 남편 분은 의사, 아내 분은 실장님으로 계신 병원이었는데요.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "인테리어나 개설 허가 등 다른 신경 쓰실 일이 많았음에도 ",
						k: 0,
					},
					{
						t: "마케팅에 정말 적극적으로 협조",
			...
			},
			{
				...
				runs: [
					{
						t: "이미 저희를 만나기 전부터 의원명과 슬로건, 많은 종류의 치료 항목을 일목요연하게 정리해 놓은 상태였죠.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "정리가 잘 되어 있었기에 진료 철학을 이해하는데, 있어서 수월했고",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이를 바탕으로 홍보성 콘텐츠의 제작도 퀄리티 높게 기획이 가능했습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "특히 철학 글을 작성하고 이를 바탕으로 의원의 브랜딩을 하는 데 많은 도움이 되었습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "원장님께서 미팅하실 때 하신 말씀 중 기억에 남는 말이 있습니다",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "원장님은 한 번 병원 개원을 한 경험이 있으신 분이라 마케팅에 대해서 과감하고 열린 마음을 가지고 계셨는데요.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "개원 초가 마케팅에 있어서 정말 중요하다는 생각에 동의하셨고 ",
						k: 0,
					},
					{
						t: "과감한 비용 집행을 결정",
			...
			},
			{
				...
				runs: [
					{
						t: "(마케팅 비용은 높을수록 할 수 있는 게 정말 많아지고 그만큼 효과 또한 빠르게 나타납니다.)",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이에 정보성 콘텐츠를 비롯하여 9~10가지 정도의 상품을 구성하여 다양한 마케팅 전략을 실행할 수 있었고",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이러한 다양한 상품들이 서로 시너지 효과를 만들어 낼 수 있었죠.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "원장님과 실장님께서는 마케팅을 진행할 때도 세세한 부분에 신경 쓰기보다는 큰 방향성만 보셨고, 전문가인 저희를 전적으로 믿어주시며, 마케팅이 잘 진행되도록 협조해 주셨습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "애드리절트TV에 아주 오래된 영상 중 내부마케팅 사례로 화장실에 대표원장님의 개인 번호를 붙여둔 영상이 있습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "불만이 있다면 대표원장에게 연락 해 주시면 해결 하겠다는 내용을 화장실에 붙여 두었고,",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이 하나로 환자들이 병원에 신뢰가 가지더라~하는 내용의 영상입니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "(아직 시청을 안 하셨다면 한번 시청 해 보시길 권해드립니다.)",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "해당 의원은, 이 영상을 시청하고 실제로 실천에 옮겼습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "또한 결식 아동들을 위하여 지역 단체에 쌀을 기부하는 등 진심으로 지역 주민들을 생각하는 마음이 가득해서,",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "이 마음이 환자분들께 잘 전달되었을 것이라 생각합니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "마케팅의 성공은 결국 의사와 마케터가 하나로 호흡할 때 만들어집니다.",
						b: true,
						fs: 22,
						k: 0,
					},
			...
			},
			{
				...
				runs: [
					{
						t: "원장님께서는 기존 네트워크 의원을 정리하고 다시 개원을 준비하시면서 여러 가지 불안과 걱정이 있으셨을 거예요.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "그런데도 애드리절트를 믿고 함께해 주신 점, 진심으로 감사드립니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "새롭게 문을 열 준비를 하는 과정에서는 지도 등록과 같은 기본 절차부터 시작해, 혼자 챙기기에는 놓치기 쉬운 작은 일들이 무척 많습니다. 그렇기에 ",
						k: 0,
					},
					{
						t: "이런 세세한 부분까지 꼼꼼히 관리할 수 있고, 믿고 맡길 수 있는 회사를 선택하는 것이 중요",
						bg: "#ffd966",
						k: 1,
					},
					{
			...
			},
			{
				...
				runs: [
					{
						t: "그리고 한 번 선택을 했다면, 그다음에는 과감하고 열린 마음으로 진행해 주시는 것이 성과를 만드는 지름길입니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "앞으로 맞이할 성공적인 개원, 그 곁에는 늘 애드리절트가 함께하고 있다는 점을 꼭 기억해 주시길 바랍니다.",
						k: 0,
					},
				],
				align: "center",
	...
	{
		slug: "167542522",
		title: "[피부과마케팅] 한 달 만에 유입수가 1,000회 이상 늘어난 이후",
		excerpt:
			"원장님들마다 이 질문에 대한 답은 다르시겠지만 '내가 노력한 것을 환자가 알아줄 때'  보람차지 않다고 말하는 분은 없으실 텐데요. 저희 병원 마케터들 또한 마찬가지로 가장 보람찬 순간을 꼽으라 하면 단연코 병원 측에서 애쓴 것을 알아주고 감사하다는 말 한마디에 정말 많은 보람을 느낀다",
		summary:
			"S피부과는 처음 3개월만 계약했다가 반년 가까이 이어지고 있는 병원입니다. 광고 한 달 만에 플레이스 유입이 1,000회 가까이 늘고 신환이 증가했으며, 꾸준한 노출 관리·콘텐츠 리뉴얼·빠른 피드백으로 실장님이 감사 선물을 보낼 만큼 신뢰를 쌓았습니다.",
		faq: [
			{
				q: "S피부과는 얼마나 빨리 효과가 났나요?",
				a: "광고 시작 한 달 만에 플레이스 유입이 1,000회 가까이 늘었고, 같은 시기에 신환이 늘었다는 피드백을 받았습니다. 처음 3개월만 계약했다가 반년 가까이 이어지고 있습니다.",
			},
			{
				q: "블로그 저품질이 생기면 어떻게 하나요?",
				a: "노출이 갑자기 줄거나 검색에서 제외되는 '저품질' 현상이 생기면, 바로 새 계정을 투입해 발행을 이어가며 단기간에 노출율을 회복시킵니다.",
			},
			{
				q: "콘텐츠 관리는 어떻게 하나요?",
				a: "고객사가 요청하지 않아도 하나의 콘텐츠를 오래 썼다 싶으면 먼저 이미지 리뉴얼을 제안하고, 수정 요청에는 빠르게 응대해 후속 작업을 진행합니다.",
			},
		],
		cover: "/images/cases/167542522/1.png",
		coverW: 362,
		coverH: 587,
		blocks: [
			{
				type: "img",
				src: "/images/cases/167542522/1.png",
				w: 362,
				h: 587,
				alt: "[피부과마케팅] 한 달 만에 유입수가 1,000회 이상 늘어난 이후",
				id: 0,
			},
			{
				type: "h",
				runs: [
					{
						t: "원장님께서는 일을 하며 가장 뿌듯한 순간이 언제이신가요?",
						b: true,
						fs: 22,
						k: 0,
					},
			...
			},
			{
				...
				runs: [
					{
						t: "저희 병원 마케터들 또한 마찬가지로 가장 보람찬 순간을 꼽으라 하면",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					...
					{
						t: "병원 측에서 애쓴 것을 알아주고 감사하다는 말 한마디",
						c: "#ff0000",
						fs: 18,
						k: 1,
					},
					{
						t: "에 정말 많은 보람을 느낀다고 말씀드릴 수 있습니다.",
						fs: 18,
						k: 2,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "오늘은 얼마 전 S피부과 실장님께서 든든한 격려와 함께 커피 및 케이크 기프티콘을 선물해 주신 사례를 소개해 볼까 합니다.",
						fs: 18,
						k: 0,
					},
				],
			...
			},
			{
				...
				runs: [
					{
						t: "저희에게 실장님의 선물이 큰 의미로 다가온 이유를 설명해 드리자면 바로 대면이 아닌 메신저로 소통을 함에도",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "우리의 진심이 실장님께 잘 전달되었다는 것을 느꼈기 때문이라고 할 수 있습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "사실 S피부과는 처음 3개월만 광고를 진행 해보시겠다고 하며 계약한 병원입니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "하지만 그 계약이 어느덧 벌써 반년 가까이 이어지고 있는 것이죠.",
						k: 0,
					},
				],
				align: "center",
			...
			{
				type: "img",
				src: "/images/cases/167542522/2.png",
				w: 816,
				h: 454,
				alt: "병원홍보",
				id: 14,
			...
			{
				type: "img",
				src: "/images/cases/167542522/3.png",
				w: 816,
				h: 454,
				alt: "온라인마케팅",
				id: 16,
			...
			},
			{
				...
				runs: [
					{
						t: "★광고 한 달 만에 플레이스 유입 수가 1000회 가까이 증가한 것을 그래프를 보시면 확인하실 수 있습니다.",
						fs: 18,
						bg: "#ffd966",
						k: 0,
					},
			...
			{
				type: "img",
				src: "/images/cases/167542522/4.png",
				w: 466,
				h: 120,
				alt: "a365849fda95a.png",
				href: "https://blog.naver.com/9fdc_8190/223054525318",
				id: 19,
			},
			{
				type: "p",
				runs: [
					{
						t: "이전에 성공사례로도 한 번 작성했듯, S피부과는 피부과 마케팅 이후 무려 ",
						k: 0,
					},
					{
						t: "한 달 만에 신환이 늘었다는 피드백을 전해 주신 병원",
						c: "#ff0000",
						k: 1,
					},
					{
			...
			},
			{
				...
				runs: [
					{
						t: "(이는 플레이스 조회수를 통하여 수치적으로도 확인되는 바 입니다.)",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "저희는 이러한 피드백에 정말 감사하며 지금 상황에 안주하지 않고 꾸준히 S병원 피부과마케팅을 위하여 최선을 다하고 있습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "그 결과가 실장님께서 선물까지 주시는 것으로 이어졌다고 볼 수 있는 것이죠.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "그렇다면 도대체 어떤 노력을 지속했기에 이런 결과가 나올 수 있었는지 지금부터 예시를 들어 간단히 설명해 보도록 하겠습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			{
				type: "img",
				src: "/images/cases/167542522/5.png",
				w: 502,
				h: 173,
				alt: "병원광고",
				id: 26,
			},
			{
				...
				runs: [
					{
						t: "블로그를 이용하여 피부과마케팅을 진행하다 보면, 흔히 '블로그가 죽는다'라고 표현하는 블로그 저품질 현상이 간간이 발생하고는 합니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "S피부과 또한 마찬가지로 이 상황을 겪었지만, 저희는 바로 새로운 계정을 투입 후 발행을 지속하였고",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "★'블로그 저품질' - 서서히 노출이 줄어들다가 어느 날 갑자기 블로그의 글이 전부 검색에서 제외되는 현상",
						bg: "#ffd966",
						k: 0,
					},
				],
			...
			{
				type: "img",
				src: "/images/cases/167542522/6.png",
				w: 364,
				h: 148,
				alt: "병원개원",
				id: 32,
			},
			{
				...
				runs: [
					{
						t: "다음으로는 고객사 측에서 요청을 하지 않아도, 하나의 콘텐츠를 오래 사용했다 싶으면",
						k: 0,
					},
				],
				align: "center",
			...
			{
				type: "img",
				src: "/images/cases/167542522/7.png",
				w: 363,
				h: 465,
				alt: "부산병원마케팅",
				id: 36,
			},
			{
				...
				runs: [
					{
						t: "마지막으로 말씀드리고 싶은 부분은 바로 소통에 있어서 빠른 피드백이 이루어졌다는 점입니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "아무래도 사람이 하는 일이다 보니 작업에 착오가 가끔씩 생기기 마련인데요.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "S피부과 측에서 특정한 수정 요청이 들어오면 저희는 항상 빠른 응대 후 후속 작업을 진행했습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "물론 누군가에게는 이런 선물이 작게 느껴질 수도 있습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "그러나 저희가 실장님의 선물에 큰 의미를 담고 이렇게 글까지 작성하는 이유는",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "애드리절트의 진심을 알고 믿어 주시는 그 마음에 대한 회답으로,",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "감사함을 함께 담아 성공사례 글을 작성해 보았습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "오늘 소개해 드린 이야기는 한 직원과 한 고객사의 예시였지만,",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "애드리절트에서는 이처럼 고객사와 선물이 오가는 사례를 흔하게 만나볼 수 있습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "해야 할 일만 주고 받는 사무적 관계가 아닌, 진심으로 서로를 신뢰하며 함께 할 수 있는 피부과 마케팅 업체를 찾고 계신 원장님들이라면",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "언제든 애드리절트의 문을 한번 두드려 보시길 바라겠습니다.",
						k: 0,
					},
				],
				align: "center",
			...
			},
			{
				...
				runs: [
					{
						t: "다음에는 또 다른 성공 사례로 찾아 오도록 하겠습니다.",
						k: 0,
					},
				],
				align: "center",
